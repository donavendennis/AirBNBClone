...
namespace AirBNBClone.Pages.Demo.Fees
{
    public class IndexModel : PageModel
    {
        ...
        public List<Fee> objFeeList;  //our UI front end will support looping through and displaying Categories retrieved from the database and stored in a List
